<h1 align="center"><img src="https://raw.githubusercontent.com/mantasu/outline-sections/main/assets/icon.png" width=24px height=24px> Outline Sections</h1>
...
[![release](https://img.shields.io/github/v/release/mantasu/outline-sections?label=🏷️%20release)](https://github.com/mantasu/outline-sections/releases/latest)
...
| -------------------: | :----------------- | -----------: | :--------- |
| [![typescript](https://img.shields.io/badge/-JavaScript-grey?logo=javascript)](https://developer.mozilla.org/en-US/docs/Web/JavaScript) [![typescript](https://img.shields.io/badge/-TypeScript-grey?logo=typescript)](https://www.typescriptlang.org/) | [typescript-language-features](https://github.com/microsoft/vscode/tree/main/extensions/typescript-language-features) (built-in) | `// #region Name` | `// #endregion` |
...
Open `extension.ts` and press **F5** (`fn + F5` if on Mac) to launch _VS Code Extension Development Window_ with the extension loaded.
